            ...
            <div class="dlabnav-scroll">
                ...
                <ul class="metismenu" id="menu">
                    ...
                    <li><a class="has-arrow " href="javascript:void()" aria-expanded="false">
                            ...
                            <span class="nav-text">User TopUp</span>
                        </a>
                        <ul aria-expanded="false">
                            <li><a href="{{ route('Admin.Allot.Plan') }}">Allot Plan</a></li>
                            <li><a href="{{ route('Admin.History.Alloting.Plans') }}">History</a></li>
                        </ul>
                    </li>
                    <li><a class="has-arrow " href="javascript:void()" aria-expanded="false">
                            <div class="menu-icon">
                    ...
                    <li><a class="has-arrow " href="javascript:void()" aria-expanded="false">
                        ...
                        <ul aria-expanded="false">
                            <li><a href="{{ route('Admin.Today.Deposit.Requests') }}">Today Requests</a></li>
                            <li><a href="{{ route('Admin.Pending.Deposit.Requests') }}">Pending Requests</a></li>
                            <li><a href="{{ route('Admin.Approved.Deposit.Requests') }}">Approved Requests</a></li>
                            <li><a href="#">Rejected Requests</a></li>
                        </ul>
                    </li>
                    <li><a class="has-arrow " href="javascript:void()" aria-expanded="false">
                    ...
                    <li><a class="has-arrow" href="javascript:void()" aria-expanded="false">
                        ...
                        <ul aria-expanded="false">
                            ...
                            <li><a href="{{ route('Admin.Sold.Plans') }}">Sold Plans</a></li>
                        </ul>
                    </li>
                </ul>
                <div class="copyright">
